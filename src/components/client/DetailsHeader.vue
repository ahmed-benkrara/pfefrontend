<template>
    <div class="w-[calc(100%-20px)] mx-auto sm:h-[140px] md:h-[300px] plx flex items-center">
        <div class="sm:pl-0 md:pl-20 w-full">
            <h1 class="w-full sm:text-center md:text-left text-white font-poppins sm:text-[23px] md:text-[40px] font-[500]">Inventory Management</h1>
            <p class="w-full sm:text-center md:text-left text-white sm:text-[12px] md:text-[16px]">Home . Inventory Management</p>
        </div>
    </div>
</template>
