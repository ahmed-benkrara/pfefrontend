        ...
        <div class="flex-1 lg:flex lg:justify-center lg:items-center">
            <div class="sm:mx-auto sm:w-[90%] md:w-[80%] lg:w-[80%] h-fit px-8 py-10 rounded-lg bg-[white]">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex-1 mt-3">
                        <input type="password" v-model="informations.confirm" id="confirm" placeholder="Confirm Password" class="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring" />
                    </div>
                    ...
                    <button id="login" @click="signup()" class="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#255de1] rounded-md focus:outline-none focus:ring focus:ring-[#255de1] focus:ring-opacity-50">
                        Sign Up
                    </button>
                    <!-- <div v-if="!getRegisterErrors.loading && Object.keys(getRegisterErrors.errors).length > 0">
                        <div class=" text-red-300 " v-if="getRegisterErrors.errors.fname">
                            {{ getRegisterErrors.errors.fname }}
                        </div>
                    </div> -->
                </div>
            </div>
